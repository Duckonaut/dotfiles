...
theme.wallpaper                                 = os.getenv("HOME") .. "/Pictures/nomansdream3.png"
theme.font                                      = "Hack 10"
theme.fg_normal                                 = "#a9b3d9"
theme.fg_focus                                  = "#dcdfe4"
theme.fg_urgent                                 = "#FFFFFF"
theme.bg_normal                                 = base_col
theme.bg_focus                                  = "#395fdc"
...
theme.mpd = lain.widget.mpd({
    settings = function()
        ...
        widget:set_markup(markup.font(theme.font, markup(base_col, artist) .. title))
    end
})
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup("#449871", " " .. string.format("%06.1f", net_now.received))
                          .. " " ..
                          markup("#3898c2", " " .. string.format("%06.1f", net_now.sent) .. " ")))
    end
})
