...
-- Destroy all notifications
    ...
    awful.key({}, "XF86AudioPlay", function()
        ...
        beautiful.update_music("multiplayerctl toggle")
    end),
    awful.key({}, "XF86AudioNext", function()
        --awful.spawn.with_shell("multiplayerctl next")
        beautiful.update_music("multiplayerctl next")
    end),
    awful.key({}, "XF86AudioPrev", function()
        --awful.spawn.with_shell("multiplayerctl previous")
        beautiful.update_music("multiplayerctl previous")
    end),
    awful.key({}, "XF86AudioStop", function()
        --awful.spawn.with_shell("multiplayerctl switch")
        beautiful.update_music("multiplayerctl switch")
    end),
