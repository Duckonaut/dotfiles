...
globalkeys = mytable.join(
	...
	awful.key({}, "XF86AudioPlay", function()
		awful.util.spawn("multiplayerctl toggle", false) end),
	awful.key({}, "XF86AudioNext", function()
		awful.util.spawn("multiplayerctl next", false) end),
	awful.key({}, "XF86AudioPrev", function()
		awful.util.spawn("multiplayerctl previous", false) end),
	awful.key({}, "XF86AudioStop", function()
		awful.util.spawn("multiplayerctl switch", false) end),
